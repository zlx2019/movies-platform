package com.movies.generator.utils;

import cn.hutool.core.date.DateUtil;
import com.movies.common.constant.CommonConst;
import com.movies.generator.model.ColumnEntity;
import com.movies.generator.model.TableEntity;
...
public class GenUtils {
    ...
    private final static String CURRENT_MODULE_NAME = "currentModelName";
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("classname", tableEntity.getClassname());
        String[] split = tableEntity.getTableName().split("_");
        ...
        map.put("pathName", stringBuffer.toString().toLowerCase());
        map.put("columns", tableEntity.getColumns());
        map.put("hasBigDecimal", hasBigDecimal);
        map.put("mainPath", mainPath);
        map.put(PACKAGE, config.getString(PACKAGE));
        map.put(CURRENT_MODULE_NAME, config.getString(CURRENT_MODULE_NAME));
        map.put(MODULE_NAME, config.getString(MODULE_NAME));
        map.put("author", config.getString("author"));
        map.put("email", config.getString("email"));
        map.put("date", DateUtil.format(new Date(), CommonConst.DATE_FORMAT));
