 ...
 *
 * @author L
 * @date 2020年10月17日 11:42:11
 */
@Slf4j
public class FeignCustomIsolationConfig extends HystrixConcurrencyStrategy {
    private HystrixConcurrencyStrategy delegate;

    public FeignCustomIsolationConfig() {
        try {
            this.delegate = HystrixPlugins.getInstance().getConcurrencyStrategy();
            if (this.delegate instanceof FeignCustomIsolationConfig) {
